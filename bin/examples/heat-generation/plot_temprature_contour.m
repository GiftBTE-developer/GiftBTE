...
%%
load 2e-7/TempLattice.dat; % load temperature results calculated from GiftBTE for L=2e-7m
L=2e-7;
t=TempLattice;
X1=0:0.01:1;
Y1=0:0.01:1;
...
%%
load 1e-5/TempLattice.dat; % load temperature results calculated from GiftBTE for L=1e-5m
L=1e-5;
t=TempLattice;
X1=0:0.01:1;
Y1=0:0.01:1;
