...
load 20/Tempcell.dat;

scatter(Tempcell(:,3)/20e-9,Tempcell(:,4),100, 'r');
hold on
...
load 50/Tempcell.dat;

scatter(Tempcell(:,3)/50e-9,Tempcell(:,4),100, 'r');
hold on

load 220/Tempcell.dat;

scatter(Tempcell(:,3)/220e-9,Tempcell(:,4),100, 'r');
hold on
