...
load Tempcell_ref_20.dat; % load temperature results for L=20nm

load Tempcell_ref_50.dat; % load temperature results for L=50nm

load Tempcell_ref_220.dat; % load temperature results for L=220nm
