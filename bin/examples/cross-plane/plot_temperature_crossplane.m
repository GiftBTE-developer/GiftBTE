...
load 1e-8/TempLattice.dat; % GiftBTE
load analytic_201806/T1e-8.dat; % analytical model
L=1e-8;
...
load 1e-7/TempLattice.dat; % GiftBTE
load analytic_201806/T1e-7.dat; % analytical model
L=1e-7;
scatter(TempLattice(:,2)/L,TempLattice(:,4)-300,80,'r'); % non-dimensional x position versus Temperature rise
hold on
...
load 1e-6/TempLattice.dat; % GiftBTE
load analytic_201806/T1e-6.dat; % analytical model
L=1e-6;
scatter(TempLattice(:,2)/L,TempLattice(:,4)-300,80,'r'); % non-dimensional x position versus Temperature rise
hold on
